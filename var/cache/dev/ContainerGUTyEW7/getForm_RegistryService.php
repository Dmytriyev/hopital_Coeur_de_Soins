...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\ConsultationForm' => ['privates', 'App\\Form\\ConsultationForm', 'getConsultationFormService', true],
            'App\\Form\\DossierMedicalForm' => ['privates', 'App\\Form\\DossierMedicalForm', 'getDossierMedicalFormService', true],
            'App\\Form\\ImageForm' => ['privates', 'App\\Form\\ImageForm', 'getImageFormService', true],
            'App\\Form\\MyProfilForm' => ['privates', 'App\\Form\\MyProfilForm', 'getMyProfilFormService', true],
            'App\\Form\\ObservationForm' => ['privates', 'App\\Form\\ObservationForm', 'getObservationFormService', true],
            'App\\Form\\PrescriptionForm' => ['privates', 'App\\Form\\PrescriptionForm', 'getPrescriptionFormService', true],
            'App\\Form\\RDVForm' => ['privates', 'App\\Form\\RDVForm', 'getRDVFormService', true],
            'App\\Form\\RegistrationForm' => ['privates', 'App\\Form\\RegistrationForm', 'getRegistrationFormService', true],
            'App\\Form\\SpecialiteForm' => ['privates', 'App\\Form\\SpecialiteForm', 'getSpecialiteFormService', true],
            'App\\Form\\UserEditForm' => ['privates', 'App\\Form\\UserEditForm', 'getUserEditFormService', true],
            ...
            'App\\Form\\ConsultationForm' => '?',
            'App\\Form\\DossierMedicalForm' => '?',
            'App\\Form\\ImageForm' => '?',
            'App\\Form\\MyProfilForm' => '?',
            'App\\Form\\ObservationForm' => '?',
            'App\\Form\\PrescriptionForm' => '?',
            'App\\Form\\RDVForm' => '?',
            'App\\Form\\RegistrationForm' => '?',
            'App\\Form\\SpecialiteForm' => '?',
            'App\\Form\\UserEditForm' => '?',
            'App\\Form\\UserForm' => '?',
