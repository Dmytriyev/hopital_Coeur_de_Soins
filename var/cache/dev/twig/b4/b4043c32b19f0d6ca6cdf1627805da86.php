...
class __TwigTemplate_6e1738b97d28e5e2c42f5f4d00a4bf60 extends Template
{
    ...
    <table class=\"table\">
        ...
        yield "            <tr>
                ...
                <td>";
        // line 16
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["consultation"]) || array_key_exists("consultation", $context) ? $context["consultation"] : (function () { throw new RuntimeError('Variable "consultation" does not exist.', 16, $this->source); })()), "dateConsultation", [], "any", false, false, false, 16)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, (isset($context["consultation"]) || array_key_exists("consultation", $context) ? $context["consultation"] : (function () { throw new RuntimeError('Variable "consultation" does not exist.', 16, $this->source); })()), "dateConsultation", [], "any", false, false, false, 16), "d/m/Y H:i"), "html", null, true)) : (""));
        yield "</td>
            </tr>
            <tr>
                <th>Compte rendu</th>
                <td>";
        // line 20
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["consultation"]) || array_key_exists("consultation", $context) ? $context["consultation"] : (function () { throw new RuntimeError('Variable "consultation" does not exist.', 20, $this->source); })()), "compteRendu", [], "any", false, false, false, 20), "html", null, true);
        yield "</td>
            </tr>
        </tbody>
    </table>
...
{% block body %}
    ...
    <a class=\"btn btn-outline-dark btn-primary mb-3\" href=\"{{ path('app_consultation_index') }}\">Retour à la liste</a>
...
{% endblock %}
", "consultation/show.html.twig", "/Users/macbookm1pro/Document/formation beauvoir/Symfony/hopital_Coeur_de_Soins/templates/consultation/show.html.twig");
    }
}
