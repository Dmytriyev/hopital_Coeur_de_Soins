...
class __TwigTemplate_a8c7e84ac92c285d1523c66ae14160ca extends Template
{
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["observation"]) || array_key_exists("observation", $context) ? $context["observation"] : (function () { throw new RuntimeError('Variable "observation" does not exist.', 12, $this->source); })()), "id", [], "any", false, false, false, 12), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                <th>Observation</th>
