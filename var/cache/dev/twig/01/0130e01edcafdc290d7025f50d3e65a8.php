...
class __TwigTemplate_ff3da910b60bb45857bc40d5d27b5062 extends Template
{
    ...
    <input type=\"hidden\" name=\"_token\" value=\"";
        ...
        yield "\">
    <button class=\"btn btn-outline-dark btn-primary\">Supprimer Utilisateur</button>
</form>
";
    ...
    {
        return new Source("<form class= \"mx-auto col-4 mb-4\" method=\"post\" action=\"{{ path('app_user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Vous entez sur de vouloir de suprimer?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-outline-dark btn-primary\">Supprimer Utilisateur</button>
</form>
", "user/_delete_form.html.twig", "/Users/macbookm1pro/Document/formation beauvoir/Symfony/hopital_Coeur_de_Soins/templates/user/_delete_form.html.twig");
    }
}
