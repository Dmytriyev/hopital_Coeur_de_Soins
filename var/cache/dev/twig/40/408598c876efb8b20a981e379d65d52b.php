...
class __TwigTemplate_02163845eed8af721aa922a0f56adf50 extends Template
{
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["dossier_medical"]) {
            ...
            yield "            <tr>
                <td>";
            // line 22
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["dossier_medical"], "id", [], "any", false, false, false, 22), "html", null, true);
            yield "</td>
                <td>";
            // line 23
    ...
    <table class=\"table\">
        ...
        {% for dossier_medical in dossier_medicals %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('app_dossier_medical_show', {'id': dossier_medical.id}) }}\">show</a>
