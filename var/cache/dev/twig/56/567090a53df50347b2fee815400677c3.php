...
class __TwigTemplate_ddcc099bb701657cf56f2baa08cdae8a extends Template
{
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for specialite in specialites %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('app_specialite_show', {'id': specialite.id}) }}\">show</a>
    ...
    <a href=\"{{ path('app_specialite_new') }}\">Create new</a>
{% endblock %}
