...
/* rdv/show.html.twig */
class __TwigTemplate_8b9e0dd47b91495dd977c45165e0bee3 extends Template
{
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["rdv"]) || array_key_exists("rdv", $context) ? $context["rdv"] : (function () { throw new RuntimeError('Variable "rdv" does not exist.', 12, $this->source); })()), "id", [], "any", false, false, false, 12), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                <th>Nom_patient</th>
...
{% block body %}
    ...
    <table class=\"table\">
        <tbody>
            ...
            <tr>
                <th>Date_rdv</th>
                <td>{{ rdv.dateRdv ? rdv.dateRdv|date('Y-m-d H:i:s') : '' }}</td>
            </tr>
        </tbody>
    </table>
