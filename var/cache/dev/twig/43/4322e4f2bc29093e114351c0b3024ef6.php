...
/* rdv/index.html.twig */
class __TwigTemplate_da923f1912d1f76e0d22c5164c0c13e6 extends Template
{
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["rdv"]) {
            ...
            // line 22
            yield "                <td>";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::capitalize($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["rdv"], "rdvPatient", [], "any", false, false, false, 22), "nom", [], "any", false, false, false, 22)), "html", null, true);
            yield "</td>
                <td>";
            // line 23
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::capitalize($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["rdv"], "rdvMedecin", [], "any", false, false, false, 23), "nom", [], "any", false, false, false, 23)), "html", null, true);
            yield "</td>
                <td>";
            // line 24
...
";
    ...
    {
        return array (  170 => 39,  166 => 38,  161 => 35,  152 => 31,  150 => 30,  142 => 27,  138 => 26,  133 => 24,  129 => 23,  124 => 22,  121 => 20,  116 => 19,  107 => 12,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for rdv in rdvs %}
            <tr>
                {# <td>{{ rdv.id }}</td> #}
                <td>{{ rdv.rdvPatient.nom | capitalize }}</td>
                <td>{{ rdv.rdvMedecin.nom | capitalize }}</td>
