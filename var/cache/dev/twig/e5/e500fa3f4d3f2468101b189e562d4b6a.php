...
class __TwigTemplate_c7df620e40af808fa4fb33950ed5b385 extends Template
{
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["observation"]) {
            ...
            yield "            <tr>
                <td>";
            // line 21
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["observation"], "id", [], "any", false, false, false, 21), "html", null, true);
            yield "</td>
                <td>";
            // line 22
            ...
            yield "</td>
                <td>";
            // line 23
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["observation"], "dateObservation", [], "any", false, false, false, 23)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["observation"], "dateObservation", [], "any", false, false, false, 23), "Y-m-d H:i:s"), "html", null, true)) : (""));
            yield "</td>
                <td>";
            // line 24
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["observation"], "matricule", [], "any", false, false, false, 24), "html", null, true);
            yield "</td>
                <td>
                    <a href=\"";
            // line 26
...
{% block title %}Observation index{% endblock %}
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for observation in observations %}
            <tr>
                ...
                <td>{{ observation.dateObservation ? observation.dateObservation|date('Y-m-d H:i:s') : '' }}</td>
                <td>{{ observation.matricule }}</td>
                <td>
                    <a href=\"{{ path('app_observation_show', {'id': observation.id}) }}\">show</a>
                    <a href=\"{{ path('app_observation_edit', {'id': observation.id}) }}\">edit</a>
                </td>
            </tr>
        {% else %}
            <tr>
    ...
    <a href=\"{{ path('app_observation_new') }}\">Create new</a>
{% endblock %}
