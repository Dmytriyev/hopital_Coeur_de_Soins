...
class __TwigTemplate_bc913d8d07c53b1bf642628027400f18 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <form class= 'w-50 m-auto border p-3 my-3' method=\"post\">
        ";
        // line 7
        ...
        // line 33
        yield "
        <button class=\"btn btn-outline-dark btn-primary col-4 mt-3\" type=\"submit\">Se Connecter</button>
    </form>
";
    ...
    {
        return array (  145 => 33,  140 => 22,  134 => 19,  127 => 16,  119 => 13,  116 => 12,  114 => 11,  111 => 10,  105 => 8,  103 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    <form class= 'w-50 m-auto border p-3 my-3' method=\"post\">
        {% if error %}
        ...
        {% if app.user %}
            <div class=\"mb-3\">
                Vous etez connecter {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Se deconnecter</a>
            </div>
        {% endif %}
\t\t<img src=\"{{ asset('/images/Hopital.png') }}\" height=\"150\" alt=\" Logo\"/>
        <h1 class=\"h3 mb-3 font-weight-normal\">Bienvenue</h1>
        <label for=\"username\">Email</label>
...
{% endblock %}
", "security/login.html.twig", "/Users/macbookm1pro/Document/formation beauvoir/Symfony/hopital_Coeur_de_Soins/templates/security/login.html.twig");
    }
}
