 ...
 */
class getVichUploader_Listener_Clean_DossierMedicalImagesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.dossier_medical_images' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.dossier_medical_images'])) {
            return $container->privates['vich_uploader.listener.clean.dossier_medical_images'];
        }

        return $container->privates['vich_uploader.listener.clean.dossier_medical_images'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('dossier_medical_images', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
