...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/Fixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/Image.php';
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\Fixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\Image(), 'groups' => []], ['fixture' => new \App\DataFixtures\User(), 'groups' => []], ['fixture' => new \App\DataFixtures\UserFixture(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []]]);
